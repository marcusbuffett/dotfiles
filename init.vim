...
Plug 'liuchengxu/vim-clap', { 'do': { -> clap#installer#download_binary() } }
...
" command! -bang -nargs=* RgText call fzf#vim#grep(<q-args>, {'options': '--delimiter : --nth 4..'}, <bang>0)
...
"
" nnoremap ,a :Clap grep2<CR>
" vnoremap ,a :Clap grep2 ++query=@visual<CR>
nnoremap ,a :Rg<CR>
...
" nnoremap ,n :Clap coc_actions<CR>
...
let g:clap_layout = {'width': '90%', 'height': '20%', 'row': '5%', 'col': '5%', 'relative': 'editor'}
...
" let g:coc_global_extensions = ['coc-ultisnips', "coc-snippets", "coc-lists", "coc-emmet", "coc-diagnostic", "coc-tsserver", "coc-json", "coc-html", "coc-css", "coc-pairs"]
...
nnoremap <Leader>so :14split ~/scratch.md<CR>
...
""" Telescope
" nnoremap <leader>fp <cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown({}))<cr>
" nnoremap <leader>fn <cmd>lua require('telescope.builtin').buffers(require('telescope.themes').get_dropdown({}))<cr>
