...
" command! -bang FilesWithWorkspace call fzf#run(fzf#wrap({ 'source': '{ find .; }' }, <bang>0))
...
" let g:coc_global_extensions = ['coc-ultisnips', "coc-snippets", "coc-lists", "coc-emmet", "coc-diagnostic", "coc-tsserver", "coc-rls", "coc-json", "coc-html", "coc-css", "coc-pairs"]
