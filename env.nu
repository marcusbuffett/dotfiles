...
let-env PATH = ($env.PATH | split row (char esep) | prepend './node_modules/.bin/')

let-env ZK_NOTEBOOK_DIR = "$env.HOME/zk-notebook"

let-env PNPM_HOME = $"($env.HOME)/Library/pnpm"
let-env PATH = ($env.PATH | append $env.PNPM_HOME)
let-env PATH = ($env.PATH | split row (char esep) | prepend '/opt/homebrew/opt/postgresql@15/bin:$PATH')
