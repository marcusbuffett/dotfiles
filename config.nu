...
alias fuck_it_lets_do_it_live = git add -u and git commit --amend --no-edit and git push --force origin HEAD
alias g = git
alias k = kubectl
...
# alias fgrecb = git for-each-ref --sort=committerdate refs/heads/ --format="%(refname:short)" | tac | fzf --no-sort | xargs git checkout
...
# todo: fzf history: https://github.com/nushell/nushell/issues/1616#issuecomment-1386714173
